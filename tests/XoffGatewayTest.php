...
use Omnipay\Beanstream\XoffGateway;
...
{
  /**
   * @var Omnipay/Beanstream/SystemGateway
   */
    public $gateway;
    ...
    public function testPurchase()
    {
        ...
        $this->assertInstanceOf('Omnipay\Beanstream\Message\XoffAuthorizeResponse', $response);
    ...
    public function testCompletePurchase()
    {
        ...
        $this->assertInstanceOf('Omnipay\Beanstream\Message\XoffCompletePurchaseRequest', $request);
